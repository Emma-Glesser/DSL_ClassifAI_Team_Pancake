...
class Convolution extends CNNLayer{
    ...
    void setFilters(Integer filters) {
        if (this.filters != null) {
            throw new Invalid_DSL_SyntaxeException("Can't call `filters` twice in a same layer")
        }
    ...
    void setKernelSize(Integer[] kernel_size) {
        if (this.kernelSize != null) {
            throw new Invalid_DSL_SyntaxeException("Can't call `kernel_size` twice in a same layer")
        }
    ...
    void setPadding(ClassifAI_DSL.Padding padding) {
        if (this.padding != null) {
            throw new Invalid_DSL_SyntaxeException("Can't call `padding` twice in a same layer")
        }
    ...
    void setActivationFunction(ClassifAI_DSL.ActivationFunction activation_function) {
        if (this.activationFunction != null) {
            throw new Invalid_DSL_SyntaxeException("Can't call `activation_function` twice in a same layer")
        }
    ...
    String getCode(int layerNumber) {
        if (filters == null) {
            throw new Invalid_DSL_SyntaxeException("Convolution layer should have a filters value")
        }
        if (filters <= 0) {
            throw new Invalid_DSL_SyntaxeException("Filters must be greater than 0")
        }
        if (kernelSize == null) {
            throw new Invalid_DSL_SyntaxeException("Convolution layer should have a kernel_size value")
        }
        if (kernelSize.length != 2) {
            throw new Invalid_DSL_SyntaxeException("Convolution layer should have a kernel_size value with 2 dimensions")
        }
